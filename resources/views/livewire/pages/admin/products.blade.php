            ...
            <form wire:submit="save" class="p-6">
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="lg:col-span-2">
                        ...
                        <input type="text" wire:model="name" placeholder="{{ __('products.name_placeholder') }}"
                    ...
                    <div>
                        <label class="mb-1.5 block text-xs font-semibold text-content/50">{{ __('products.selling_price') }} ({{ __('common.currency') }})</label>
                    ...
                    <div>
                        <label class="mb-1.5 block text-xs font-semibold text-content/50">{{ __('products.stock') }} ({{ __('common.pieces') }})</label>
