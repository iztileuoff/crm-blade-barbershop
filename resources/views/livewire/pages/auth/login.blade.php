...
<div class="min-h-screen lg:grid lg:grid-cols-[1fr_1.05fr]">
    ...
    <div class="relative flex min-h-screen items-center justify-center px-6 py-12 lg:min-h-0">
        <x-theme-toggle class="absolute right-5 top-5 flex h-10 w-10 items-center justify-center rounded-xl border border-line text-content/50 transition hover:border-brass/40 hover:text-brass-ink" />
        ...
        <div class="w-full max-w-sm">
            ...
            <div class="mt-14">
                <h1 class="font-display text-5xl font-semibold uppercase leading-none tracking-tight text-content">Вход</h1>
                <div class="razor-stroke animate-razor mt-4 w-32"></div>
                <p class="mt-5 text-sm text-content/50">Панель управления барбершопом</p>
            </div>

            {{-- Form --}}
            <form wire:submit.prevent="login" class="mt-9 flex flex-col gap-5">
                <div>
                    <label for="phone" class="mb-2 block text-[11px] font-semibold uppercase tracking-[0.18em] text-content/55">Телефон</label>
                    <div class="relative">
                ...
                <div>
                    <label for="password" class="mb-2 block text-[11px] font-semibold uppercase tracking-[0.18em] text-content/55">Пароль</label>
                    <div class="relative">
                        <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-content/35">
    ...
    <div class="bg-brushed relative hidden overflow-hidden border-l border-line lg:block">
        ...
        <div class="relative flex h-full flex-col justify-between p-14">
            <div class="font-display text-xs font-semibold uppercase tracking-[0.4em] text-brass-ink/70">Система управления</div>
