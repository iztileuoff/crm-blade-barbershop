...
class Barber extends Model implements HasMedia
{
    ...
    private function validTimeWindow(mixed $start, mixed $end): ?array
    {
        ...
        // Смена «до полуночи» — единственное окно, где конец меньше начала по
        // строке и всё-таки валиден: `<input type="time">` не умеет выдать 24:00,
        // так что полночь приходит как 00:00. Без этой ветки график вида
        // 20:00–00:00 отбрасывался целиком, и мастер молча получал часы салона
        // вместо своей вечерней смены (issue #96).
