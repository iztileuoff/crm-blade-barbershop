...
return [
    ...
    // Validation
    'err_overnight_too_long' => 'Конец раньше начала. Через полночь визит может длиться не дольше :hours часов.',
    'err_add_service' => 'Добавьте хотя бы одну услугу.',
    'err_client_required' => 'Выберите клиента — запись без него не сохранится.',
